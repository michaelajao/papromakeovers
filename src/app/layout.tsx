...
import { Geist_Mono, Cormorant_Garamond, Inter_Tight } from "next/font/google";
...
export const metadata: Metadata = {
  ...
  // Favicon configuration — src/app/icon.svg is auto-detected by Next.js;
  // these entries pin the public SVGs so older browsers/tools find them too.
  icons: {
    icon: [
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      ...
      <body
        className={`${interTight.variable} ${geistMono.variable} ${cormorant.variable} antialiased`}
      >
        {children}
        <RevealOnScroll />
        <Analytics />
